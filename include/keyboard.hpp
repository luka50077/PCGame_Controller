...
class Keyboard : public LED, public Switch, public Encoder {
 private:
  ...
  uint8_t key_map_DIVA_Play[SWITCH_NUM] = {
      ...
      KEYCODE_TAB, KEYCODE_B, KEYCODE_N, KEYCODE_M, KEYCODE_RESERVED};
  ...
  const uint8_t key_map_KALPA_4k[SWITCH_NUM] = {
      ...
      KEYCODE_F5, KEYCODE_K, KEYCODE_L, KEYCODE_RESERVED, KEYCODE_ENTER};
  const uint8_t key_map_KALPA_5k_RIGHT[SWITCH_NUM] = {
      KEYCODE_ESCAPE,   KEYCODE_D, KEYCODE_S, KEYCODE_RESERVED, KEYCODE_Down,
      KEYCODE_F5, KEYCODE_J, KEYCODE_K, KEYCODE_L,        KEYCODE_ENTER};
  const uint8_t key_map_KALPA_5k_LEFT[SWITCH_NUM] = {
      KEYCODE_ESCAPE,   KEYCODE_T, KEYCODE_R, KEYCODE_E, KEYCODE_Down,
      KEYCODE_F5, KEYCODE_I, KEYCODE_O, KEYCODE_RESERVED, KEYCODE_ENTER};
  const uint8_t key_map_BMS[SWITCH_NUM] = {
      KEYCODE_ESCAPE,   KEYCODE_D, KEYCODE_S, KEYCODE_A, KEYCODE_W,
      KEYCODE_C, KEYCODE_J, KEYCODE_K, KEYCODE_L, KEYCODE_M};
