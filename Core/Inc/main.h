...
/* Private defines -----------------------------------------------------------*/
#define SpaceL_Pin GPIO_PIN_2
#define SpaceL_GPIO_Port GPIOA
...
#define Escape_Pin GPIO_PIN_7
#define Escape_GPIO_Port GPIOC
...
#define SpaceR_Pin GPIO_PIN_9
#define SpaceR_GPIO_Port GPIOB
